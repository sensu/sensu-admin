...
* Downtimes stay in scheduled unless they get started, e.g. the whenever job never runs
* mouseover events in red should stay red
...
* Fix events js so it only fires on the events page
