...
* Put delete/edit/destroy tabs on downtimes
* Update homepage to put some stats
* When deleting stashes show a working message and then make the stashes # update.
